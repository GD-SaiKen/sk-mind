...
| 3 | IWC_ITEM_ID | 主键 | GUID | Y | Y |
| 4 | IWC_ITEM_CODE | 攻略云项目编号 | string(60) | Y |  |
| 5 | IWC_ITEM_NAME | 攻略云项目名称 | string(840) | Y |  |
| 6 | TAX_REGION_ID | 税区 | GUID | Y |  |
| 7 | SYS_FLAG | 系统项目标识 | number(0/1) | Y |  |
| 8 | IWC_ITEM_CATEGORY | 攻略云项目性质 | number | Y |  |
| 9 | PROCESS_ITEM_FLAG | 中间项目标识 | number(0/1) | Y |  |
| 10 | SUMMARY_ITEM_FLAG | 汇总项目标识 | number(0/1) | Y |  |
| 11 | IWC_ITEM_LEVEL | 攻略云项目层级 | number | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | IWC_ITEM_FORMULA_ID | 主键 | GUID | Y | Y |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | TAX_REGION_ID | 税区 | GUID | Y |  |
...
| 2 | IWC_ITEM_ID | 攻略云集成项目 | GUID | Y |  |
| 3 | PROCESS_ITEM_FLAG | 中间项目标识 | number(0/1) | Y |  |
| 4 | SUMMARY_ITEM_FLAG | 汇总项目标识 | number(0/1) | Y |  |
| 5 | DATA_FORMULA | 取数公式 | string | Y |  |
| 6 | DATA_FORMULA_OOQL | 取数公式OOQL | string | Y |  |
| 7 | REMARK | 备注 | string(510) | Y |  |
| 8 | IWC_ITEM_FORMULA_D_ID | 主键 | GUID | Y | Y |
