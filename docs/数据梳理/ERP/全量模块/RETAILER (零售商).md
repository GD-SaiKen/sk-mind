...
| 3 | RETAILER_CODE_ID | 主键 | GUID | Y | Y |
| 4 | SALES_CENTER_ID | 销售域 | GUID | Y |  |
| 5 | MAIN_CUSTOMER_ID | 总店号 | GUID | Y |  |
| 6 | FEATURE_ID | 属性项 | GUID | Y |  |
...
| 2 | RETAILER_CODE_D_ID | 主键 | GUID | Y | Y |
| 3 | BRANCH_CUSTOMER_ID | 店别 | GUID | Y |  |
| 4 | FEATURE_D_ID | 属性值 | GUID | Y |  |
| 5 | RETAIL_SALES_CODE | 店别代码 | string(40) | Y |  |
| 6 | SELLER_PLANT_CODE | 供应商厂编 | string(40) | Y |  |
| 7 | REMARK | 备注 | string(510) | Y |  |
| 8 | CreateDate | 创建日期 | date | Y |  |
| 9 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 10 | ModifiedDate | 修改日期 | date | Y |  |
