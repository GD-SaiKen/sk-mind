...
- **INSP_DOC_D (巡检单单身)**
- **INSP_DOC_SD (巡检单子单身)**
- **INSP_TEMPLET (维护设备巡检模板)**
- **INSP_TEMPLET_D (维护巡检模板单身信息)**
- **INSP_TEMPLET_SD (维护巡检模板子单身信息)**
...
| 6 | INSP_DOC_ID | 主键 | GUID | Y | Y |
| 7 | TRANSACTION_DATE | 巡检日期 | date | Y |  |
| 8 | INSP_TEMPLET_ID | 巡检模板 | GUID | Y |  |
...
| 2 | INSP_DOC_D_ID | 主键 | GUID | Y | Y |
| 3 | EQUIPMENT_ID | 设备 | GUID | Y |  |
| 4 | EQT_CATEGORY_ID | 设备类别 | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | INSPECTION_JOB_ID | 巡检项目 | GUID | Y |  |
| 3 | INSP_DOC_SD_ID | 主键 | GUID | Y | Y |
| 4 | CHECKED | 已检 | number(0/1) | Y |  |
| 5 | INSPECTION_RESULT | 巡检结果 | string(510) | Y |  |
| 6 | NO_INSPECTION | 不检 | number(0/1) | Y |  |
| 7 | INSPECTION_SITUATION | 巡检情况说明 | string(510) | Y |  |
| 8 | ADD_KNOWLEDGE_BASE | 加入知识库 | number(0/1) | Y |  |
| 9 | REMARK | 备注 | string(510) | Y |  |
| 10 | UDF001 | 自定义字段0 | number(23,8) | Y |  |
| 11 | UDF002 | 自定义字段1 | number(23,8) | Y |  |
| 12 | UDF003 | 自定义字段2 | number(23,8) | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | INSP_TEMPLET_ID | 主键 | GUID | Y | Y |
| 4 | INSP_TEMPLET_CODE | 巡检模板编号 | string(80) | Y |  |
| 5 | INSP_TEMPLET_NAME | 巡检模板名称 | string(160) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | INSP_TEMPLET_D_ID | 主键 | GUID | Y | Y |
| 3 | EQUIPMENT_ID | 设备编号 | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | INSP_TEMPLET_SD_ID | 主键 | GUID | Y | Y |
| 3 | INSPECTION_JOB_ID | 巡检项目 | GUID | Y |  |
