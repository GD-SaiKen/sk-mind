...
| 4 | SUPPLIER_CODE | 供应商编号 | string(20) | Y |  |
| 5 | SUPPLIER_NAME | 供应商简称 | string(40) | Y |  |
| 6 | SUPPLIER_FULL_NAME | 供应商全称 | string(144) | Y |  |
| 7 | SHORT_CUT |  | string(40) | Y |  |
| 8 | TAX_NO | 税号 | string(40) | Y |  |
| 9 | BUSINESS_LICENCE | 营业执照 | string(40) | Y |  |
| 10 | PRINCIPAL | 负责人 | string(40) | Y |  |
| 11 | REG_CAPITAL | 注册资金 | number(23,8) | Y |  |
| 12 | TURNOVER | 年营业额 | number(23,8) | Y |  |
| 13 | REG_ADDRESS | 注册地址 | string(510) | Y |  |
| 14 | STAFFS | 员工人数 | number | Y |  |
| 15 | SETUP_DATE | 成立日期 | date | Y |  |
| 16 | SHUTOUT_DATE | 停业日期 | date | Y |  |
| 17 | INNER_SUPPLIER | 内部供应商 | number(0/1) | Y |  |
| 18 | REMARK | 备注 | string(510) | Y |  |
| 19 | BP_CLUSTER_ID | 交易对象群组 | GUID | Y |  |
| 20 | REG_CAPITAL_CURRENCY_ID | 注册资金币种 | GUID | Y |  |
| 21 | TURNOVER_CURRENCY_ID | 年营业额币种 | GUID | Y |  |
| 22 | INNER_COMPANY_ID | 內部公司编号 | GUID | Y |  |
| 23 | CARRIERS | 承运商 | number(0/1) | Y |  |
