...
| 3 | GLBUDGET_ID | 主键 | GUID | Y | Y |
| 4 | GLBUDGET_DESC_ID | 预算 | GUID | Y |  |
| 5 | DEPT_BUDGET_FLAG | 部门预算标识 | number(0/1) | Y |  |
| 6 | ADMIN_UNIT_ID | 部门 | GUID | Y |  |
| 7 | ACCOUNT_BOOK | 账簿 | number | Y |  |
| 8 | ACCOUNT_CODE_ID | 科目 | GUID | Y |  |
| 9 | ACCOUNT_YEAR | 会计年度 | string(8) | Y |  |
| 10 | ANNUAL_BUDGET_AMT | 年度预算金额 | number(23,8) | Y |  |
| 11 | BUDGET_PERIOD_CONTROL_FLAG | 展期标识 | number(0/1) | Y |  |
| 12 | BUDGET_PERIOD_TOTAL_AMT | 各期预算合计 | number(23,8) | Y |  |
| 13 | AUXILIARY_ITEM | 科目辅助核算项目 | string(20) | Y |  |
...
| 2 | GLBUDGET_D_ID | 主键 | GUID | Y | Y |
| 3 | BUDGET_PERIOD_CODE | 期号 | string(20) | Y |  |
| 4 | BUDGET_AMT | 预算金额 | number(23,8) | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | GLBUDGET_DESC_ID | 主键 | GUID | Y | Y |
| 4 | BUDGET_CODE | 预算编号 | string(12) | Y |  |
| 5 | BUDGET_NAME | 预算名称 | string(60) | Y |  |
