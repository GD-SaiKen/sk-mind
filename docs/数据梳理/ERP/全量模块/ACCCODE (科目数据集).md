...
### ACCCODE_ANALYSIS_PROPERTY - 科目分析属性

| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | ACCCODE_ANALYSIS_PROPERTY_ID | 主键 | GUID | Y | Y |
| 4 | ACCCODE_ANALYSIS_PROPERTY_CODE | 科目分析属性编号 | string(12) | Y |  |
| 5 | ACCCODE_ANALYSIS_PROPERTY_NAME | 科目分析属性名称 | string(40) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | ACCCODE_DATASET_ID | 会计科目表信息 | GUID | Y |  |
...
### ACCCODE_CATEGORY - 科目类别信息

| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | ACCCODE_CATEGORY_ID | 主键 | GUID | Y | Y |
| 4 | ACCCODE_CATEGORY_CODE | 科目类别编号 | string(16) | Y |  |
| 5 | ACCCODE_CATEGORY_NAME | 科目类别名称 | string(60) | Y |  |
| 6 | ACCCODE_CATEGORY_FULL_NAME | 科目类别全称 | string(510) | Y |  |
| 7 | ACCCODE_INITIAL_INDICATOR | 控制科目首位编码 | number(0/1) | Y |  |
| 8 | ACCCODE_INITIAL_RULE | 科目首位编码规则 | string(2) | Y |  |
| 9 | ACCCODE_CATEGORY_LEVEL | 科目类别层级 | number | Y |  |
| 10 | ALLOW_ADDACCCODE_INDICATOR | 允许增加下级科目 | number(0/1) | Y |  |
| 11 | REMARK | 备注 | string(510) | Y |  |
| 12 | FATHER_ACCCODE_CATEGORY_ID | 所属类别 | GUID | Y |  |
...
### ACCCODE_DATASET - 会计科目表

| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | ACCCODE_DATASET_ID | 主键 | GUID | Y | Y |
| 4 | ACCCODE_DATASET_CODE | 科目表编号 | string(12) | Y |  |
| 5 | ACCCODE_DATASET_NAME | 科目表名称 | string(40) | Y |  |
| 6 | DATASET_TYPE | 科目表类型 | number | Y |  |
| 7 | DATASET_AREA | 科目表性质 | number | Y |  |
| 8 | ACCCODE_LEVEL | 科目级次 | number | Y |  |
| 9 | ACCCODE_CODEMODE | 科目编码规则 | string(60) | Y |  |
| 10 | ACCCODE_CATEGORY_LEVEL | 科目类别级次 | number | Y |  |
| 11 | ACCCODE_CATEGORY_CODEMODE | 科目类别编码规则 | string(20) | Y |  |
