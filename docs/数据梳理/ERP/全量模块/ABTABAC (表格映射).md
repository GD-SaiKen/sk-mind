...
| 3 | ABTABAC_MAPPING_ID | 主键 | GUID | Y | Y |
| 4 | ABTABVC_SCHEME_ID | 复制方案 | GUID | Y |  |
...
| 2 | ABTABAC_MAPPING_D_ID | 主键 | GUID | Y | Y |
| 3 | SOURCE_ACCOUNT_CODE_ID | 源会计科目 | GUID | Y |  |
| 4 | TARGET_ACCOUNT_CODE_ID | 目的会计科目 | GUID | Y |  |
| 5 | REMARK | 备注 | string(510) | Y |  |
| 6 | CreateDate | 创建日期 | date | Y |  |
| 7 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 8 | ModifiedDate | 修改日期 | date | Y |  |
