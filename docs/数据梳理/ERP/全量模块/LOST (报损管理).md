...
| 6 | LOST_GOODS_ID | 主键 | GUID | Y | Y |
| 7 | CATEGORY | 单据性质 | string(40) | Y |  |
| 8 | SHOP_ID | 门店 | GUID | Y |  |
| 9 | LOST_DATE | 丢失日期 | date | Y |  |
| 10 | WAREHOUSE_ID | 报失仓库 | GUID | Y |  |
...
| 51 | COST_DOMAIN_ID_RTK |  | string(400) | Y |  |
| 52 | COST_DOMAIN_ID_ROid |  | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | LOST_REASON_ID | 主键 | GUID | Y | Y |
| 4 | LOST_REASON_CODE | 报失原因编号 | string(80) | Y |  |
| 5 | LOST_REASON_NAME | 报失原因名称 | string(200) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | ACCOUNT_CODE_ID | 财务科目编号 | GUID | Y |  |
