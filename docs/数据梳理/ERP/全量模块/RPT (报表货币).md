...
- **RPT_CURRENCY**
- **RPT_CURRENCY_D**
- **RPT_CURRENCY_EXCHANGE**
- **RPT_CURRENCY_EXCHANGE_D**
...
| 3 | RPT_CURRENCY_ID | 主键 | GUID | Y | Y |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | CURRENCY_ID | 报告货币 | GUID | Y |  |
...
| 2 | RPT_CURRENCY_D_ID | 主键 | GUID | Y | Y |
| 3 | CURRENCY_ID | 数据货币 | GUID | Y |  |
| 4 | EXG_TYPE | 汇率类型 | number | Y |  |
| 5 | EXG_DECIMAL_PLACE | 汇率小数取位 | number | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | RPT_CURRENCY_EXCHANGE_ID | 主键 | GUID | Y | Y |
| 4 | CURRENCY_ID | 报告货币 | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | RPT_CURRENCY_EXCHANGE_D_ID | 主键 | GUID | Y | Y |
| 3 | CURRENCY_ID | 数据货币 | GUID | Y |  |
| 4 | CURRENT_EXG | 现行汇率 | number(18,9) | Y |  |
| 5 | AVERAGE_EXG |  | number(18,9) | Y |  |
| 6 | HISTORICAL_EXG | 历史汇率 | number(18,9) | Y |  |
...
| 31 | UDF054 | 自定义字段17 | GUID | Y |  |
| 32 | Version | 版本号，不要随意更改 | binary | Y |  |
| 33 | RPT_CURRENCY_EXCHANGE_ID |  | GUID | Y |  |