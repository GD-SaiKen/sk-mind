...
| 3 | WIPEU_ESTI_SETUP_ID | 主键 | GUID | Y | Y |
| 4 | PLANT_ID | 工厂 | GUID | Y |  |
| 5 | COST_TRANSFER_MODE | 成本结转方式 | number | Y |  |
...
| 2 | WIPEU_ESTI_SETUP_D_ID | 主键 | GUID | Y | Y |
| 3 | IM_COST_CATEGORY2_ID | 存货成本分类2 | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | WIPEU_ESTI_SETUP_SD_ID | 主键 | GUID | Y | Y |
| 3 | COST_ELEMENT_ID | 成本要素 | GUID | Y |  |
| 4 | COST_SOURCE | 成本来源 | number | Y |  |
| 5 | CLWIPEU_METHOD | 本阶在制约量估算方法 | number | Y |  |
| 6 | LLWIPEU_METHOD | 下阶在制约量估算方法 | number | Y |  |
...
| 33 | WIPEU_ESTI_SETUP_D_ID |  | GUID | Y |  |