...
- **ITEM_PLANT20181024 (品号工厂信息备份20181024)**
...
| 1 | Owner_Dept |  | GUID | Y |  |
| 2 | Owner_Emp |  | GUID | Y |  |
| 3 | CYCLE_COUNT_CODE |  | string(8) | Y |  |
| 4 | ITEM_PROPERTY |  | string(40) | Y |  |
| 5 | ABC_CLASS |  | string(2) | Y |  |
| 6 | REMARK |  | string(510) | Y |  |
| 7 | ITEM_PICTURE |  | string(400) |  |  |
| 8 | STORAGE_CONTROL |  | string(40) | Y |  |
| 9 | WAREHOUSE_CONTROL |  | string(40) | Y |  |
| 10 | ISSUE_DESTINATION_TYPE |  | string(40) | Y |  |
| 11 | RECEIPT_OVERRUN_RATE |  | number(5,4) | Y |  |
| 12 | DYNAMIC_LEAD_TIME_M |  | number(16,1) | Y |  |
| 13 | FIXED_LEAD_TIME_M |  | number(16,1) | Y |  |
| 14 | ISSUE_MULTIPLE |  | number(16,6) | Y |  |
| 15 | INSPECT_MODE |  | string(40) | Y |  |
| 16 | INSPECT_DAYS |  | number(16,1) | Y |  |
| 17 | ROUTING_CONTROL |  | number(0/1) | Y |  |
| 18 | BATCH_QUANTITY_M |  | number(16,6) | Y |  |
| 19 | MIN_ORDER_QTY |  | number(16,6) | Y |  |
| 20 | ORDER_MULTIPLE |  | number(16,6) | Y |  |
| 21 | STRICTNESS_DEGREE |  | string(80) | Y |  |
| 22 | YIELD_RATE |  | number(5,4) | Y |  |
| 23 | RESERVED_RULE |  | string(6) | Y |  |
| 24 | RESERVED_VALID_DAY |  | number(16,1) | Y |  |
| 25 | RESERVED_CONTROL |  | number(0/1) | Y |  |
| 26 | ISSUE_OVERRUN_RATE |  | number(5,4) | Y |  |
| 27 | ISSUE_SHORTAGE_RATE |  | number(5,4) | Y |  |
| 28 | LOW_LEVEL_CODE |  | string(4) | Y |  |
| 29 | IS_CRITICAL_ITEM |  | number(0/1) | Y |  |
| 30 | ORDER_POLICY |  | string(40) | Y |  |
| 31 | SAFE_STOCK |  | number(16,6) | Y |  |
| 32 | PLAN_ORDER_RULE |  | string(40) | Y |  |
| 33 | MAX_ORDER_QTY |  | number(16,6) | Y |  |
| 34 | IS_INTEGER |  | number(0/1) | Y |  |
| 35 | IS_CONSOLIDATED |  | number(0/1) | Y |  |
| 36 | CONSOLIDATE_DAY |  | number | Y |  |
| 37 | LOT_MO_QTY |  | number(16,6) | Y |  |
| 38 | ITEM_ID |  | GUID | Y |  |
| 39 | STORAGE_LIMIT_ID |  | GUID | Y |  |
| 40 | MO_ISSUE_UNIT_ID |  | GUID | Y |  |
| 41 | WORK_CENTER_ID |  | GUID | Y |  |
| 42 | STANDARD_ROUTING_ID |  | GUID | Y |  |
| 43 | INBOUND_WAREHOUSE_ID |  | GUID | Y |  |
| 44 | OUTBOUND_WAREHOUSE_ID |  | GUID | Y |  |
| 45 | MO_DOC_ID |  | GUID | Y |  |
| 46 | SALES_CENTER_ID |  | GUID | Y |  |
| 47 | MRP_TIME_BUCKET |  | GUID | Y |  |
| 48 | REQUISITION_DOC_ID |  | GUID | Y |  |
| 49 | PLANNER_ID |  | GUID | Y |  |
| 50 | ISSUE_TYPE |  | string(40) | Y |  |
| 51 | REPLENISHMENT_CYCLE_ID |  | GUID | Y |  |
| 52 | LOT_MO_LEAD_TIME |  | number(16,1) | Y |  |
| 53 | REORDER_POINT |  | number(16,6) | Y |  |
| 54 | ECONOMIC_ORDER_QTY |  | number(16,6) | Y |  |
| 55 | STANDARD_MAN_HOUR |  | number | Y |  |
| 56 | STANDARD_MACHINE_HOUR |  | number | Y |  |
| 57 | MULTIPURPOSE_CSTAF |  | number(16,6) | Y |  |
| 58 | PRODUCTION_ADMIN_UNIT_ID |  | GUID | Y |  |
| 59 | MIM_DISTRIBUTION_QTY |  | number(16,6) | Y |  |
| 60 | DISTRIBUTION_MULTIPLE |  | number(16,6) | Y |  |
| 61 | BEST_STOCK |  | number(16,6) | Y |  |
| 62 | CYCLE_ORDER_CODE |  | string(8) | Y |  |
| 63 | ADD_DRP |  | number(0/1) | Y |  |
| 64 | ORDER_LEAD |  | number | Y |  |
| 65 | IS_DIRECT |  | number(0/1) | Y |  |
| 66 | ORDER_SUPPLY_CENTER_ID |  | GUID | Y |  |
| 67 | ORDER_PLANT_ID |  | GUID | Y |  |
| 68 | ORDER_SUPPLIER_ID |  | GUID | Y |  |
| 69 | LOGISTICS_UNIT_ID |  | GUID | Y |  |
| 70 | LOT_CONTROL |  | string(40) | Y |  |
| 71 | DISTRIBUTION_TYPE |  | string(40) | Y |  |
| 72 | SUPPLY_CENTER_ID |  | GUID | Y |  |
| 73 | ORDER_DOC_ID |  | GUID | Y |  |
| 74 | ISSUE_CRITICAL |  | number(0/1) | Y |  |
| 75 | IS_DISTRIBUTION |  | string(40) | Y |  |
| 76 | TRANSPORT_DAYS |  | number(7,3) | Y |  |
| 77 | TRANSFER_OUT_PLANT_ID |  | GUID | Y |  |
| 78 | IS_INDEPENDENT_DEMAND |  | number(0/1) | Y |  |
| 79 | TRANSFER_REQUISITION_ID |  | GUID | Y |  |
| 80 | QC_CATEGORY_ID |  | GUID | Y |  |
| 81 | INSPECTION_UNIT_ID |  | GUID | Y |  |
| 82 | SOURCE |  | string(40) | Y |  |
| 83 | PLM_DATAKEY |  | string(80) | Y |  |
| 84 | WAREHOUSE_ID |  | GUID | Y |  |
| 85 | BIN_ID |  | GUID | Y |  |
| 86 | UNIT1_ID |  | GUID | Y |  |
| 87 | UNIT2_ID |  | GUID | Y |  |
| 88 | LONG |  | number(16,6) | Y |  |
| 89 | HIGH |  | number(16,6) | Y |  |
| 90 | WIDE |  | number(16,6) | Y |  |
| 91 | BULK |  | number(16,6) | Y |  |
| 92 | WEIGHT |  | number(16,6) | Y |  |
| 93 | WEIGHT1 |  | number(16,6) | Y |  |
| 94 | PRODUCE_UNIT_ID |  | GUID | Y |  |
| 95 | TRANSACTION_UNIT_ID |  | GUID | Y |  |
| 96 | ITEM_BUSINESS_ID |  | GUID | Y |  |
| 97 | ITEM_ROUTING_CONTROL |  | string(40) | Y |  |
| 98 | DISTRIBUTION_PRICE |  | number(23,8) | Y |  |
| 99 | SYNERGY_ID |  | GUID | Y |  |
| 100 | INNER_ORDER_DOC_ID |  | GUID | Y |  |
| 101 | PURCHASE_CONSIDER_ORDER |  | number(0/1) | Y |  |
| 102 | RESERVED_PLAN_001 |  | string(40) | Y |  |
| 103 | RESERVED_PLAN_002 |  | string(40) | Y |  |
| 104 | RESERVED_PLAN_003 |  | number(0/1) | Y |  |
| 105 | Version |  | binary | Y |  |
| 106 | CreateDate |  | date | Y |  |
| 107 | LastModifiedDate |  | date | Y |  |
| 108 | ModifiedDate |  | date | Y |  |
| 109 | CreateBy |  | GUID | Y |  |
| 110 | LastModifiedBy |  | GUID | Y |  |
| 111 | ModifiedBy |  | GUID | Y |  |
| 112 | Attachments |  | string | Y |  |
| 113 | ProcessInstanceId |  | GUID | Y |  |
| 114 | ApproveStatus |  | string(2) | Y |  |
| 115 | ApproveDate |  | date | Y |  |
| 116 | ApproveBy |  | GUID | Y |  |
| 117 | UDF001 |  | number(23,8) | Y |  |
| 118 | UDF002 |  | number(23,8) | Y |  |
| 119 | UDF003 |  | number(23,8) | Y |  |
| 120 | UDF011 |  | number(16,6) | Y |  |
| 121 | UDF012 |  | number(16,6) | Y |  |
| 122 | UDF013 |  | number(16,6) | Y |  |
| 123 | UDF021 |  | string(510) | Y |  |
| 124 | UDF022 |  | string(510) | Y |  |
| 125 | UDF023 |  | string(510) | Y |  |
| 126 | UDF024 |  | string(510) | Y |  |
| 127 | UDF025 |  | string(510) | Y |  |
| 128 | UDF026 |  | string(510) | Y |  |
| 129 | UDF041 |  | date | Y |  |
| 130 | UDF042 |  | date | Y |  |
| 131 | UDF051 |  | GUID | Y |  |
| 132 | UDF052 |  | GUID | Y |  |
...
| 135 | Owner_Org_RTK |  | string(400) | Y |  |
| 136 | Owner_Org_ROid |  | GUID | Y |  |
| 137 | MRP_CRITICAL_ITEM_TYPE |  | string(40) | Y |  |
| 138 | CONSOLIDATED |  | string(40) | Y |  |
