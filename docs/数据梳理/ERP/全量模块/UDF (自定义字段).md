...
- **UDF_ISSUE_DESTINATION (自定义领料对象信息)**
- **UDF_ISSUE_DESTINATION_D (自定义领料对象工艺信息)**
...
| 3 | UDF_ISSUE_DESTINATION_ID | 主键 | GUID | Y | Y |
| 4 | UDF_ISSUE_DESTINATION_CODE | 编号 | string(80) | Y |  |
| 5 | UDF_ISSUE_DESTINATION_NAME | 名称 | string(120) | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | UDF_ISSUE_DESTINATION_D_ID | 主键 | GUID | Y | Y |
| 2 | REMARK | 备注 | string(510) | Y |  |
| 3 | OPERATION_ID | 工艺 | GUID | Y |  |
...
| 32 | UDF_ISSUE_DESTINATION_ID |  | GUID | Y |  |