...
- **DISASSEMBLY_COST_RATE (拆件工单成本比率)**
- **DISASSEMBLY_COST_RATE_D**
...
| 3 | DISASSEMBLY_COST_RATE_ID | 主键 | GUID | Y | Y |
...
| 11 | ITEM_SPECIFICATION |  | string(510) | Y |  |
...
| 2 | DISASSEMBLY_COST_RATE_D_ID | 主键 | GUID | Y | Y |
| 3 | ITEM_ID | 品号 | GUID | Y |  |
| 4 | ITEM_NAME |  | string(120) | Y |  |
| 5 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 6 | ITEM_SPECIFICATION |  | string(510) | Y |  |
| 7 | REMARK | 备注 | string(510) | Y |  |
| 8 | PRODUCT_TYPE | 产出类型 | number | Y |  |
| 9 | UNIT_COST_DISASSEMBLY_RATE | 单位成本拆分比率 | number(5,4) | Y |  |
...
| 35 | DISASSEMBLY_COST_RATE_ID |  | GUID | Y |  |