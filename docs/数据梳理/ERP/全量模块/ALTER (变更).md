...
- **ALTER_ACCOUNT_CODE (维护备选会计科目)**
- **ALTER_CASHFLOW_ITEM (备选现金流量项目)**
...
| 3 | ALTER_ACCOUNT_CODE_ID | 主键 | GUID | Y | Y |
| 4 | ACCCODE | 科目编号 | string(60) | Y |  |
| 5 | ACCCODE_NAME | 科目名称 | string(80) | Y |  |
| 6 | ACCCODE_FULL_NAME | 科目全称 | string(840) | Y |  |
| 7 | ACCCODE_ALIAS | 科目别名 | string(840) | Y |  |
| 8 | BALANCE_DIRECTION | 科目余额方向 | number | Y |  |
| 9 | COEFFICIENT_INDICATOR | 系数科目 | number(0/1) | Y |  |
| 10 | ACCCODE_LEVEL | 科目层级 | number | Y |  |
| 11 | ACCCODE_DATASET_ID | 科目表编号 | GUID | Y |  |
| 12 | ACCCODE_CATEGORY_ID | 科目所属类别 | GUID | Y |  |
| 13 | ACCCODE_ANALYSIS_PROPERTY_ID | 科目分析属性 | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | ALTER_CASHFLOW_ITEM_ID | 主键 | GUID | Y | Y |
| 4 | CASHFLOW_ITEM_CODE |  | string(24) | Y |  |
| 5 | CASHFLOW_ITEM_NAME |  | string(80) | Y |  |
| 6 | CASHFLOW_ITEM_PROPERTY | 现金流量项目流向性质 | number | Y |  |
| 7 | CASHFLOW_ITEM_LEVEL | 现金流量项目层级 | number | Y |  |
| 8 | CASHFLOW_DATASET_ID | 现金流量表编号 | GUID | Y |  |
