...
- **CS_SAMPING_PLAN (自定义抽样方案)**
- **CS_TAX_CLASSIFICATION (客户/供应商税分类)**
...
|---|--------|-------------|------|----------|----|
| 1 | CS_SAMPING_PLAN_ID | 主键 | GUID | Y | Y |
| 2 | BEGINNING_SIZE | 起始批量 | number | Y |  |
| 3 | ENDDING_SIZE | 截止批量 | number | Y |  |
| 4 | INSPECTION_METHOD | 抽样方式 | string(40) | Y |  |
| 5 | SAMPLE_SIZE | 样本量n | number(16,6) | Y |  |
| 6 | AC | AC | number(16,6) | Y |  |
| 7 | RE | RE | number(16,6) | Y |  |
| 8 | DISPOSAL_PLAN | 说明 | string(400) | Y |  |
...
| 3 | CS_TAX_CLASSIFICATION_ID | 主键 | GUID | Y | Y |
| 4 | CS_TAX_CLASSIFICATION_CODE | 客户/供应商税分类编号 | string(6) | Y |  |
| 5 | CS_TAX_CLASSIFICATION_NAME | 客户/供应商税分类名称 | string(60) | Y |  |
