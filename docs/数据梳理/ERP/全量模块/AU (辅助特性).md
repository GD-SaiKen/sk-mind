...
| 3 | AU_CHARACTER_ID | 主键 | GUID | Y | Y |
| 4 | AU_CHARACTER_CODE | 属性项编码 | string(20) | Y |  |
| 5 | AU_CHARACTER_NAME | 属性项名称 | string(40) | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | AU_CHARACTER_D_ID | 主键 | GUID | Y | Y |
| 2 | AU_CHARACTER_VALUE | 属性值 | string(20) | Y |  |
| 3 | AU_CHARACTER_VALUE_DESC |  | string(40) | Y |  |
