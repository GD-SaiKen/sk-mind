...
> Database: E10_3.0.0.2_CHS | **Server**: .\SQLEXPRESS | **Tables**: 1,989 | **Columns**: 90599
 | Server: .\\SQLEXPRESS | Tables: 2 | Generated: 2026-06-25 10:52
...
| 3 | ABTABVC_SCHEME_ID | 主键 | GUID | Y | Y |
| 4 | ABTABVC_SCHEME_CODE | 方案编号 | string(12) | Y |  |
| 5 | ABTABVC_SCHEME_NAME | 方案名称 | string(60) | Y |  |
| 6 | SOURCE_ACCOUNT_BOOK | 源账簿 | number | Y |  |
| 7 | TARGET_ACCOUNT_BOOK | 目的账簿 | number | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
| 9 | EXG_STRATEGY | 汇率策略 | number | Y |  |
...
| 2 | ABTABVC_SCHEME_D_ID | 主键 | GUID | Y | Y |
| 3 | SOURCE_VOUCHER_TYPE_ID | 源凭证类型 | GUID | Y |  |
| 4 | SVT_NATURE | 源凭证类型性质 | string(40) | Y |  |
| 5 | TVT_RESTRICTIVE | 目的凭证类型性质约束 | string(40) | Y |  |
| 6 | TARGET_VOUCHER_TYPE_ID | 目的凭证类型 | GUID | Y |  |
| 7 | TVT_NATURE | 目的凭证类型性质 | string(40) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
