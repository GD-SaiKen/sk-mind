...
| 3 | MACHINE_ID | 主键 | GUID | Y | Y |
| 4 | MACHINE_CODE | 机器编号 | string(30) | Y |  |
| 5 | MACHINE_DESCRIPTION | 机器名称 | string(60) | Y |  |
| 6 | MACHINE_CAPACITY | 机器产能 | number(16,6) | Y |  |
| 7 | MACHINE_LOADING_RATIO | 机器负荷率 | number(5,4) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
| 9 | MACHINE_TEAM_ID | 机器组 | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | MACHINE_TEAM_ID | 主键 | GUID | Y | Y |
| 4 | TEAM_CODE | 机器组编号 | string(30) | Y |  |
| 5 | TEAM_DESCRIPTION | 机器组名称 | string(60) | Y |  |
| 6 | TEAM_CAPACITY | 机器组产能 | number(16,6) | Y |  |
| 7 | TEAM_RATIO | 机器组负荷率 | number(5,4) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
