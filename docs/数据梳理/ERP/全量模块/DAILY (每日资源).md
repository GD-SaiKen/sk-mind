...
- **DAILY_RESOURCE (每日资源信息)**
- **DAILY_RESOURCE_D (每日资源单身信息)**
...
| 4 | DAILY_RESOURCE_ID | 主键 | GUID | Y | Y |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | DAILY_RESOURCE_D_ID | 主键 | GUID | Y | Y |
| 2 | DAILY_RESOURCE_DATE |  | date | Y |  |
| 3 | DAILY_CAPACITY | 当日产能 | number(8,2) | Y |  |
| 4 | WIP_CONSUMPTION | 主要产能 | number(8,2) | Y |  |
| 5 | PLAN_CONSUMPTION | 计划主要耗用 | number(8,2) | Y |  |
