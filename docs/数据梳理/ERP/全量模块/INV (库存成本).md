...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | INV_COST_CALC_LOG_ID | 主键 | GUID | Y | Y |
| 4 | COMPANY_ID | 公司 | GUID | Y |  |
| 5 | ACCOUNT_YEAR | 会计年度 | string(8) | Y |  |
| 6 | ACCOUNT_PERIOD_SEQNO | 会计期间序号 | number | Y |  |
| 7 | CALC_TIME | 计算时间 | date | Y |  |
| 8 | ITEM_ID | 品号 | GUID | Y |  |
| 9 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 10 | CALC_USER | 主键 | GUID | Y |  |
| 11 | ABNORMAL_CODE | 异常码 | string(400) | Y |  |
| 12 | TRANSACTION_LINE_ID | 异常交易行 | GUID | Y |  |
| 13 | ITEM_LOT_ID | 主键 | GUID | Y |  |
| 14 | ABNORMAL_PROCESSED | 已做异常处理 | number(0/1) | Y |  |
| 15 | ABNORMAL_SOURCE | 异常来源 | string(40) | Y |  |
| 16 | VALUATE_METHOD | 异常发出成本赋值方式 | string(40) | Y |  |
...
| 49 | COST_DOMAIN_ID_RTK |  | string(400) | Y |  |
| 50 | COST_DOMAIN_ID_ROid |  | GUID | Y |  |
