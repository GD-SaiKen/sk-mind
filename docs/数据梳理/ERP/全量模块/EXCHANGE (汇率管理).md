...
- **EXCHANGE_DATASET (货币汇率表)**
- **EXCHANGE_DATASET_D (货币汇率表单身)**
...
| 3 | EXCHANGE_DATASET_ID | 主键 | GUID | Y | Y |
| 4 | EXCHANGE_DATASET_CODE | 货币汇率表编号 | string(12) | Y |  |
| 5 | EXCHANGE_DATASET_NAME | 货币汇率表名称 | string(40) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | BASE_CURRENCY_ID | 基本货币 | GUID | Y |  |
...
| 2 | EXCHANGE_DATASET_D_ID | 主键 | GUID | Y | Y |
| 3 | EXG_TYPE | 汇率类型 | number | Y |  |
| 4 | EXG_DECIMAL_PLACE | 汇率小数取位 | number | Y |  |
