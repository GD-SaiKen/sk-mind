...
- **WS_EXCEPTION_LOG (WebService异常记录)**
- **WS_LOG (WebService日志)**
...
|---|--------|-------------|------|----------|----|
| 1 | WS_EXCEPTION_LOG_ID | 主键 | GUID | Y | Y |
| 2 | IP | IP地址 | string(40) | Y |  |
| 3 | POS_CODE | POS机号 | string(40) | Y |  |
| 4 | SHOP_CODE | 门店编号 | string(40) | Y |  |
| 5 | CODE | 错误代码 | string(40) | Y |  |
| 6 | MESSAGE | 异常信息 | string(2000) | Y |  |
| 7 | LOG_TIME | 日志时间 | date | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | WS_LOG_ID | 主键 | GUID | Y | Y |
| 2 | IP | IP地址 | string(40) | Y |  |
| 3 | POS_CODE | POS机号 | string(40) | Y |  |
| 4 | SHOP_CODE | 门店编号 | string(40) | Y |  |
| 5 | CODE | 错误代码 | string(40) | Y |  |
| 6 | MESSAGE | 日志信息 | string(2000) | Y |  |
| 7 | LOG_TIME | 时间 | date | Y |  |
| 8 | CreateDate | 创建日期 | date | Y |  |
| 9 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 10 | ModifiedDate | 修改日期 | date | Y |  |
| 11 | CreateBy | 创建者 | GUID | Y |  |
