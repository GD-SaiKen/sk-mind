...
| 3 | ROUTE_ID | 主键 | GUID | Y | Y |
| 4 | ROUTE_CODE | 配送路线编号 | string(20) | Y |  |
| 5 | ROUTE_NAME | 配送路线名称 | string(40) | Y |  |
...
| 29 | PLANT_OBJECT_TYPE_RTK |  | string(400) | Y |  |
| 30 | PLANT_OBJECT_TYPE_ROid |  | GUID | Y |  |
| 31 | ROUTE_ID |  | GUID | Y |  |