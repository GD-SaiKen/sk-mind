...
| 2 | SORTING_D_ID | 主键 | GUID | Y | Y |
| 3 | ITEM_ID | 品号 | GUID | Y |  |
| 4 | ITEM_DESCRIPTION |  | string(120) | Y |  |
| 5 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 6 | ITEM_SPECIFICATION |  | string(510) | Y |  |
| 7 | LOGISTICS_QTY | 配送任务量 | number(16,6) | Y |  |
| 8 | SORTING_QTY | 分货量 | number(16,6) | Y |  |
| 9 | DISTRIBUTION_QTY | 已转配送量 | number(16,6) | Y |  |
| 10 | LOGISTICS_UNIT_ID | 物流单位 | GUID | Y |  |
| 11 | CONT_MAN | 订货人 | string(20) | Y |  |
| 12 | CONT_TEL | 联系电话 | string(40) | Y |  |
| 13 | RECEIVE_ADDR | 收货地址 | string(510) | Y |  |
| 14 | CLOSED | 结束码 | string(40) | Y |  |
| 15 | REMARK | 备注 | string(510) | Y |  |
| 16 | DIRECTOR | 直供发起方 | GUID | Y |  |
| 17 | PLAN_DELIVERY_DATE | 预交货日期 | date | Y |  |
...
| 43 | DISTRIBUTION_OBJECT_RTK |  | string(400) | Y |  |
| 44 | DISTRIBUTION_OBJECT_ROid |  | GUID | Y |  |
| 45 | SOURCE_ID_RTK |  | string(400) | Y |  |
| 46 | SOURCE_ID_ROid |  | GUID | Y |  |
| 47 | SOURCE_ID1_RTK |  | string(400) | Y |  |
| 48 | SOURCE_ID1_ROid |  | GUID | Y |  |
| 49 | SORTING_ID |  | GUID | Y |  |