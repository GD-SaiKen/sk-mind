...
- **FUNCTION_INFO_D (函数参数信息)**
- **FUNCTION_INFO_RETURN (函数返回明细信息)**
- **FUNCTION_LEVEL**
...
| 3 | FUNCTION_INFO_ID | 主键 | GUID | Y | Y |
| 4 | FUNCTION_INFO_NAME |  | string(120) | Y |  |
| 5 | FUNCTION_INFO_DESC_CHS |  | string(500) | Y |  |
| 6 | FUNCTION_INFO_DESC_CHT |  | string(500) | Y |  |
| 7 | FUNCTION_INFO_DESC_ENU |  | string(600) | Y |  |
| 8 | FUNCTION_INFO_TYPE |  | number | Y |  |
| 9 | FUNCTION_INFO_STYLE |  | number | Y |  |
| 10 | FUNCTION_SOURCE_TYPE |  | number | Y |  |
| 11 | FUNCTION_SOURCE |  | string | Y |  |
| 12 | FUNCTION_EXPLAIN_CHS |  | string(2000) | Y |  |
| 13 | FUNCTION_EXPLAIN_CHT |  | string(2000) | Y |  |
| 14 | FUNCTION_EXPLAIN_ENU |  | string(2000) | Y |  |
| 15 | FUNCTION_CLASS2 |  | string(400) | Y |  |
| 16 | FUNCTION_CLASS3 |  | string(200) | Y |  |
...
| 2 | FUNCTION_INFO_D_ID |  | GUID | Y | Y |
| 3 | PARAMETER_STYLE |  | number | Y |  |
| 4 | PLACEHOLDER |  | string(40) | Y |  |
| 5 | PARAMETER_CODE |  | string(80) | Y |  |
| 6 | PARAMETER_NAME |  | string(120) | Y |  |
| 7 | PARAMETER_VALUE_TYPE |  | number | Y |  |
| 8 | CONDITIONS |  | string(200) | Y |  |
| 9 | ORGANIZATION_TYPE |  | string(400) | Y |  |
| 10 | CONTROL_TYPE |  | number | Y |  |
| 11 | CONTROL_CODE |  | string(120) | Y |  |
| 12 | WINDOW_TYPEKEY |  | string(80) | Y |  |
| 13 | WINDOW_RETURN_CODE |  | string(80) | Y |  |
| 14 | REMARK |  | string(510) | Y |  |
| 15 | PARAMETER_NAME_CHT |  | string(120) | Y |  |
| 16 | PARAMETER_NAME_ENU |  | string(400) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | FUNCTION_INFO_RETURN_ID |  | GUID | Y | Y |
| 3 | RETURN_CODE |  | string(80) | Y |  |
| 4 | RETURN_NAME |  | string(120) | Y |  |
| 5 | VALUE_TYPE |  | number | Y |  |
| 6 | REMARK |  | string(510) | Y |  |
| 7 | RETURN_NAME_CHT |  | string(400) | Y |  |
| 8 | RETURN_NAME_ENU |  | string(400) | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | FUNCTION_LEVEL_ID | 主键 | GUID | Y | Y |
| 4 | FUNCTION_LEVEL_CODE | 职等编码 | string(20) | Y |  |
| 5 | FUNCTION_LEVEL_NAME | 职等名称 | string(40) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | DECISION_LEVEL_ID | 核决层级 | GUID | Y |  |
