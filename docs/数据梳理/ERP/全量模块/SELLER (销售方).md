...
- **SELLER_PLANT_CODE (卖方厂编)**
- **SELLER_PLANT_CODE_D (卖方厂编明细)**
...
| 3 | SELLER_PLANT_CODE_ID | 主键 | GUID | Y | Y |
| 4 | SALES_CENTER_ID | 销售域 | GUID | Y |  |
| 5 | FEATURE_ID | 属性项 | GUID | Y |  |
...
| 2 | SELLER_PLANT_CODE_D_ID | 主键 | GUID | Y | Y |
| 3 | FEATURE_D_ID | 属性值 | GUID | Y |  |
| 4 | SELLER_PLANT_CODE | 卖方厂编 | string(40) | Y |  |
...
| 31 | SELLER_PLANT_CODE_ID |  | GUID | Y |  |