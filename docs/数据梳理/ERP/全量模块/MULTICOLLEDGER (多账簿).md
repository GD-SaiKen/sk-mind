...
- **MULTICOLLEDGER_DEFINE (多栏账定义)**
- **MULTICOLLEDGER_DEFINE_D (多栏账定义单身)**
...
| 3 | MULTICOLLEDGER_DEFINE_ID | 主键 | GUID | Y | Y |
| 4 | MULTICOLLEDGER_CODE | 多栏账编号 | string(12) | Y |  |
| 5 | MULTICOLLEDGER_NAME | 多栏账名称 | string(60) | Y |  |
| 6 | ACCOUNT_BOOK | 账簿 | number | Y |  |
| 7 | ACCOUNT_CODE_ID | 科目 | GUID | Y |  |
| 8 | ANALYSIS_ITEM_TYPE | 分析项目类型 | string(40) | Y |  |
| 9 | ANALYSIS_LEVEL_FLAG | 指定分析项目级次标识 | number(0/1) | Y |  |
| 10 | ANALYSIS_LEVEL | 分析项目级次 | number | Y |  |
| 11 | DEF_ANALYSIS_DIRECTION | 默认分析方向 | number | Y |  |
| 12 | EXCEPTION_COLUMN_NAME | 例外栏位名称 | string(80) | Y |  |
...
| 2 | ANALYSIS_DIRECTION | 分析方向 | number | Y |  |
| 3 | COLUMN_NAME | 栏位名称 | string(80) | Y |  |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | MULTICOLLEDGER_DEFINE_D_ID | 主键 | GUID | Y | Y |
...
| 33 | MULTICOLLEDGER_DEFINE_ID |  | GUID | Y |  |