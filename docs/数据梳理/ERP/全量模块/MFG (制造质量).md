...
- **MFG_QC_RESULT (维护工单质检业务结果)**
- **MFG_QC_RESULT_D (维护工单质检业务单身)**
- **MFG_QC_RESULT_SD (维护工单质检业务子单身)**
...
| 3 | MFG_QC_RESULT_ID | 主键 | GUID | Y | Y |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | MO_ROUTING_D_ID | 后工序 | GUID | Y |  |
...
| 2 | MFG_QC_RESULT_D_ID | 主键 | GUID | Y | Y |
| 3 | QC_DATE | 检验日期 | date | Y |  |
| 4 | QUALIFIED_BUSINESS_QTY | 合格业务数量 | number(16,6) | Y |  |
| 5 | UNQUALIFIED_BUSINESS_QTY | 不合格业务数量 | number(16,6) | Y |  |
| 6 | IN_DESTROYED_BUSINESS_QTY | 检验破坏业务数量 | number(16,6) | Y |  |
| 7 | RESULT_STATUS | 判断状态 | string(40) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
| 9 | TO_DECIDE_QTY | 待判定量 | number(16,6) | Y |  |
| 10 | QC_NO | 检验单号 | string(60) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | MFG_QC_RESULT_SD_ID | 主键 | GUID | Y | Y |
| 3 | ACCEPTED_BUSINESS_QTY | 允收业务数量 | number(16,6) | Y |  |
| 4 | RETURN_BUSINESS_QTY | 拒收业务数量 | number(16,6) | Y |  |
| 5 | SP_RECEIPT_BUSINESS_QTY | 让步接收业务数量 | number(16,6) | Y |  |
| 6 | SCRAP_BUSINESS_QTY | 报废业务数量 | number(16,6) | Y |  |
| 7 | DESTROYED_BUSINESS_QTY | 破坏业务数量 | number(16,6) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
| 9 | DECIDE_DATE | 判定日期 | date | Y |  |
