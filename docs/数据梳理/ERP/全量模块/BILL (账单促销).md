...
- **BILL_PROMOTION_DOC (整单促销单)**
- **BILL_PROMOTION_DOC_D (生效门店)**
- **BILL_PROMOTION_DOC_D1 (品号范围)**
- **BILL_PROMOTION_DOC_D10 (满抵)**
- **BILL_PROMOTION_DOC_D11 (租柜费用分摊)**
- **BILL_PROMOTION_DOC_D12 (顾客范围)**
- **BILL_PROMOTION_DOC_D2 (加价购)**
- **BILL_PROMOTION_DOC_D3 (折扣)**
- **BILL_PROMOTION_DOC_D4 (满减)**
- **BILL_PROMOTION_DOC_D5 (赠券)**
- **BILL_PROMOTION_DOC_D6 (赠券)**
- **BILL_PROMOTION_DOC_D7 (赠品)**
- **BILL_PROMOTION_DOC_D8 (赠品)**
- **BILL_PROMOTION_DOC_D9 (赠卡)**
...
| 6 | BILL_PROMOTION_DOC_ID | 主键 | GUID | Y | Y |
| 7 | CATEGORY | 单据性质 | string(40) | Y |  |
| 8 | SHOP_RANGE | 门店范围 | string(40) | Y |  |
| 9 | CUSTOMER_RANGE | 顾客范围 | string(40) | Y |  |
...
| 26 | COUNTER_CHARGE_ID | 费用分摊类型 | GUID | Y |  |
| 27 | REMARK | 备注 | string(510) | Y |  |
| 28 | PROMOTION_SCHEDULE_ID | 促销活动 | GUID | Y |  |
...
| 2 | BILL_PROMOTION_DOC_D_ID | 主键 | GUID | Y | Y |
| 3 | SHOP_ID | 门店 | GUID | Y |  |
...
| 40 | BILL_PROMOTION_DOC_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D1_ID | 主键 | GUID | Y | Y |
| 3 | ITEM_ID | 品号 | GUID | Y |  |
...
| 31 | BILL_PROMOTION_DOC_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D10_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | TOTAL_MODE | 累计方式 | string(40) | Y |  |
| 7 | FULL_AMT | 满额金额 | number(23,8) | Y |  |
| 8 | USE_AMT | 抵用金额 | number(23,8) | Y |  |
...
| 35 | BILL_PROMOTION_DOC_D1_ID |  | GUID | Y |  |
...
| 1 | SequenceNumber |  | number | Y |  |
| 2 | SHOP_ID | 门店 | GUID | Y |  |
| 3 | BILL_PROMOTION_DOC_D11_ID | 主键 | GUID | Y | Y |
...
| 11 | DISCOUNT_AMT_RATE | 优惠额比率 | number(23,8) | Y |  |
...
| 39 | BILL_PROMOTION_DOC_D_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D12_ID | 主键 | GUID | Y | Y |
...
| 30 | BILL_PROMOTION_DOC_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D2_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | TOTAL_MODE | 累计方式 | string(40) | Y |  |
| 7 | ITEM_ID | 加价购商品 | GUID | Y |  |
| 8 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 9 | INCREASE_AMT | 加价金额 | number(23,8) | Y |  |
| 10 | INCREASE_QTY | 加价购数量 | number(16,6) | Y |  |
...
| 37 | BILL_PROMOTION_DOC_D1_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D3_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | DISCOUNT | 适用折扣 | number(5,4) | Y |  |
...
| 33 | BILL_PROMOTION_DOC_D1_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D4_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | TOTAL_MODE | 累计方式 | string(40) | Y |  |
| 7 | FULL_REDUCTION_AMT | 满减金额 | number(23,8) | Y |  |
...
| 34 | BILL_PROMOTION_DOC_D1_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D5_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | TOTAL_MODE | 累计方式 | string(40) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D6_ID | 主键 | GUID | Y | Y |
...
| 29 | ModifiedBy | 修改者 | GUID | Y |  |
| 30 | Version | 版本号，不要随意更改 | binary | Y |  |
| 31 | BILL_PROMOTION_DOC_D5_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D7_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
...
| 32 | BILL_PROMOTION_DOC_D1_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D8_ID | 主键 | GUID | Y | Y |
| 3 | ITEM_ID | 赠品 | GUID | Y |  |
| 4 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
...
| 30 | ModifiedBy | 修改者 | GUID | Y |  |
| 31 | Version | 版本号，不要随意更改 | binary | Y |  |
| 32 | BILL_PROMOTION_DOC_D7_ID |  | GUID | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | BILL_PROMOTION_DOC_D9_ID | 主键 | GUID | Y | Y |
| 3 | BILL_START_CALCULATION_TYPE | 起算类型 | string(40) | Y |  |
| 4 | START_CALCULATION_AMT | 起算金额 | number(23,8) | Y |  |
| 5 | START_CALCULATION_QTY | 起算数量 | number(16,6) | Y |  |
| 6 | TOTAL_MODE | 累计方式 | string(40) | Y |  |
| 7 | CARD_GROUP_ID | 赠卡类型 | GUID | Y |  |
| 8 | CARD_AMT | 赠卡金额 | number(23,8) | Y |  |
| 9 | REMARK | 备注 | string(510) | Y |  |
| 10 | UDF001 | 自定义字段0 | number(23,8) | Y |  |
| 11 | UDF002 | 自定义字段1 | number(23,8) | Y |  |
| 12 | UDF003 | 自定义字段2 | number(23,8) | Y |  |
