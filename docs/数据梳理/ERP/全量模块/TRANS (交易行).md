...
- **TRANS_EXCHANGE (业务汇率)**
- **TRANS_EXCHANGE_D (业务汇率单身)**
- **TRANS_LINE_COST_DETAIL (存货交易成本明细)**
...
| 3 | TRANS_EXCHANGE_ID | 主键 | GUID | Y | Y |
| 4 | EFFECTIVE_DATE | 生效日期 | date | Y |  |
| 5 | REMARK |  | string(510) | Y |  |
| 6 | EXCHANGE_DATASET_ID | 货币汇率表编码 | GUID | Y |  |
...
| 2 | TRANS_EXCHANGE_D_ID | 主键 | GUID | Y | Y |
| 3 | EXG_DECIMAL_PLACE | 汇率小数取位 | number | Y |  |
| 4 | BANK_BUYING_EXG | 银行买入汇率 | number(18,9) | Y |  |
| 5 | BANK_SELLING_EXG | 银行卖出汇率 | number(18,9) | Y |  |
| 6 | CUSTOMS_BUYING_EXG | 海关买入汇率 | number(18,9) | Y |  |
| 7 | CUSTOMS_SELLING_EXG | 海关卖出汇率 | number(18,9) | Y |  |
| 8 | BANK_CENTRAL_PARITY_EXG | 银行中间价 | number(18,9) | Y |  |
| 9 | ADJUSTMENT_EXG | 调整汇率 | number(18,9) | Y |  |
| 10 | REMARK |  | string(510) | Y |  |
| 11 | TRANS_CURRENCY_ID | 交易货币 | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | TRANS_LINE_COST_DETAIL_ID | 主键 | GUID | Y | Y |
| 4 | COST_ELEMENT_ID | 成本要素 | GUID | Y |  |
| 5 | COST_AMT | 成本金额 | number(23,8) | Y |  |
| 6 | COST_ATTRIBUTION | 成本归属 | number | Y |  |
| 7 | TRANSACTION_LINE_ID | 父主键 | GUID | Y |  |
| 8 | COMPANY_ID | 公司 | GUID | Y |  |
| 9 | ACCOUNT_YEAR | 会计年度 | string(8) | Y |  |
| 10 | ACCOUNT_PERIOD_SEQNO | 会计期间序号 | number | Y |  |
| 11 | TRANSACTION_DATE | 交易日期 | date | Y |  |
