...
| 3 | SECRET_STAFF_ID | 主键 | GUID | Y | Y |
| 4 | SECRET_LEVEL | 保密等級 | string(40) | Y |  |
| 5 | REMARK | 备注 | string(510) | Y |  |
| 6 | BOM_SECRET_STAFF_ID | 保密人員 | GUID | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | SECRET_STAFF_D_ID | 主键 | GUID | Y | Y |
| 2 | EFFECTIVE_DATE | 生效日期 | date | Y |  |
| 3 | EXPIRY_DATE | 失效日期 | date | Y |  |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | PARENT_ITEM_FEATURE_ID | 主件特征码 | GUID | Y |  |
