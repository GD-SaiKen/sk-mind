...
| 3 | WEBSITE_ITEM_ID | 主键 | GUID | Y | Y |
| 4 | COMMISSION_CALCULATION_METHOD | 服务费结算方式 | string(40) | Y |  |
| 5 | PATH_CUSTOMER_ID | 通路总店 | GUID | Y |  |
| 6 | BRANCH_STORES_ID | 网点代号 | GUID | Y |  |
| 7 | COMMISSION_RATE | 服务费比率 | number(5,4) | Y |  |
...
| 2 | WEBSITE_ITEM_D_ID | 主键 | GUID | Y | Y |
| 3 | ITEM_ID | 品号 | GUID | Y |  |
| 4 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 5 | RECONCILED_UNIT_ID | 对账单位 | GUID | Y |  |
| 6 | ITEM_COMMISSION_METHOD | 服务费计算法 | string(40) | Y |  |
| 7 | ITEM_COMMISSION_RATE | 服务费比率 | number(5,4) | Y |  |
| 8 | ITEM_COMMISSION_AMT | 服务费金额 | number(23,8) | Y |  |
