...
- **INSTALLMENT_TEMPLATE (分期收付款模板)**
- **INSTALLMENT_TEMPLATE_D (分期收付款模板单身)**
...
| 3 | INSTALLMENT_TEMPLATE_ID | 主键 | GUID | Y | Y |
| 4 | TEMPLATE_TYPE | 模板类别 | number | Y |  |
| 5 | TEMPLATE_CODE |  | string(12) | Y |  |
| 6 | TEMPLATE_NAME |  | string(40) | Y |  |
| 7 | TEMPLATE_AREA | 模板范围 | number | Y |  |
| 8 | REMARK | 審批意見 | string(510) | Y |  |
...
| 2 | INSTALLMENT_TEMPLATE_D_ID |  | GUID | Y | Y |
| 3 | INSTALLMENT_NAME |  | string(60) | Y |  |
| 4 | INSTALLMENT_RATE | 分期比率 | number(5,4) | Y |  |
| 5 | BASE_DATE | 基准日来源 | number | Y |  |
| 6 | REMARK | 审批 | string(510) | Y |  |
| 7 | PAYMENT_TERM_ID | 付款条件 | GUID | Y |  |
...
| 33 | INSTALLMENT_TEMPLATE_ID |  | GUID | Y |  |