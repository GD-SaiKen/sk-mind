...
- **PRICE_STRATEGY (取价策略)**
- **PRICE_STRATEGY_D (价格取价顺序)**
- **PRICE_STRATEGY_SD (折扣取折顺序)**
- **PRICE_TABLE (价格表)**
- **PRICE_TABLE_CUSTOMER (客户价格表)**
- **PRICE_TABLE_D (价格表品号价格设置)**
- **PRICE_TABLE_SD (价格表分量计价)**
- **PRICE_TERMS**
- **PRICE_TERMS_D**
...
| 3 | PRICE_STRATEGY_ID | 主键 | GUID | Y | Y |
| 4 | PRICE_STRATEGY_CODE | 取价策略编号 | string(40) | Y |  |
| 5 | PRICE_STRATEGY_NAME | 取价策略名称 | string(240) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | SALES_CENTER_DEFAULT | 销售域默认取价策略 | number(0/1) | Y |  |
...
| 2 | PRICE_STRATEGY_D_ID |  | GUID | Y | Y |
| 3 | PRICE_TYPE | 价格类型 | string(40) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | PRICE_STRATEGY_SD_ID | 主键 | GUID | Y | Y |
| 3 | DISCOUNT_TYPE | 折扣类型 | string(40) | Y |  |
| 4 | REMARK | 备注 | string(510) | Y |  |
| 5 | CreateDate | 创建日期 | date | Y |  |
| 6 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 7 | ModifiedDate | 修改日期 | date | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | PRICE_TABLE_ID | 主键 | GUID | Y | Y |
| 4 | PRICE_TABLE_CODE | 价格表编号 | string(40) | Y |  |
| 5 | PRICE_TABLE_NAME | 价格表名称 | string(240) | Y |  |
| 6 | PRICE_TYPE | 价格类型 | string(40) | Y |  |
| 7 | TAX_RATE | 限定税率 | number(5,4) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | PRICE_TABLE_CUSTOMER_ID |  | GUID | Y | Y |
| 3 | REMARK | 备注 | string(510) | Y |  |
| 4 | CUST_FEATURE_VALUE1 | 客户属性值1 | string(80) | Y |  |
| 5 | CUST_FEATURE_VALUE2 | 客户属性值2 | string(80) | Y |  |
| 6 | CUST_FEATURE_VALUE3 | 客户属性值3 | string(80) | Y |  |
| 7 | CUST_FEATURE_VALUE4 | 客户属性值4 | string(80) | Y |  |
| 8 | CUST_FEATURE_VALUE5 | 客户属性值5 | string(80) | Y |  |
| 9 | CUST_FEATURE_VALUE6 | 客户属性值6 | string(80) | Y |  |
| 10 | CUSTOMER_FEATURE1_ID | 客户属性项1 | GUID | Y |  |
| 11 | CUSTOMER_FEATURE2_ID | 客户属性项2 | GUID | Y |  |
| 12 | CUSTOMER_FEATURE3_ID | 客户属性项3 | GUID | Y |  |
| 13 | CUSTOMER_FEATURE4_ID | 客户属性项4 | GUID | Y |  |
| 14 | CUSTOMER_FEATURE5_ID | 客户属性项5 | GUID | Y |  |
| 15 | CUSTOMER_FEATURE6_ID | 客户属性项6 | GUID | Y |  |
...
| 45 | PRICE_TABLE_ID |  | GUID | Y |  |

### PRICE_TABLE_D (价格表品号价格设置)

| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | PRICE_TABLE_D_ID | 价格表单身 | GUID | Y | Y |
| 2 | ITEM_NAME |  | string(120) | Y |  |
| 3 | ITEM_SPECIFICATION |  | string(510) | Y |  |
| 4 | PRICE |  | number(23,8) | Y |  |
| 5 | EFFECTIVE_DATE | 生效日期 | date | Y |  |
| 6 | INEFFECTIVE_DATE | 失效日期 | date | Y |  |
| 7 | COMPONENT_PRICE | 分量计价 | number(0/1) | Y |  |
| 8 | DEFINED_PRICE | 可自定价格 | number(0/1) | Y |  |
| 9 | UPPER_PRICE | 上限价格 | number(23,8) | Y |  |
| 10 | LOWER_PRICE | 下限价格 | number(23,8) | Y |  |
| 11 | REMARK | 备注 | string(510) | Y |  |
| 12 | RED_PRICE | 红线价格 | number(23,8) | Y |  |
...
| 44 | PRICE_TABLE_ID |  | GUID | Y |  |

### PRICE_TABLE_SD (价格表分量计价)

| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | PRICE_TABLE_SD_ID |  | GUID | Y | Y |
| 2 | BEGIN_QTY | 数量>= | number(16,6) | Y |  |
| 3 | END_QTY | 数量< | number(16,6) | Y |  |
| 4 | PRICE |  | number(23,8) | Y |  |
| 5 | DEFINED_PRICE | 可自定价格 | number(0/1) | Y |  |
| 6 | UPPER_PRICE | 上限价格 | number(23,8) | Y |  |
| 7 | LOWER_PRICE | 下限价格 | number(23,8) | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | PRICE_TERMS_ID | 主键 | GUID | Y | Y |
| 4 | CODE | 编号 | string(8) | Y |  |
| 5 | NAME | 名称 | string(40) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
...
|---|--------|-------------|------|----------|----|
| 1 | SequenceNumber |  | number | Y |  |
| 2 | PRICE_TERMS_D_ID | 主键 | GUID | Y | Y |
| 3 | EXPENSE_ID | 费用项目 | GUID | Y |  |
| 4 | SOURCE_TYPE | 来源类型 | string(40) | Y |  |
| 5 | CALC_RATE | 比率 | number(5,4) | Y |  |
| 6 | ALLOCATION_MODE | 分摊方式 | string(40) | Y |  |
