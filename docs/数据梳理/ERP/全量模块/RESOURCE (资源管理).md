...
- **RESOURCE_D**
- **RESOURCE_GROUP (资源群组信息)**
- **RESOURCE_GROUP_D (资源群组单身信息)**
- **RESOURCE_TYPE**
...
| 3 | RESOURCE_ID | 主键 | GUID | Y | Y |
| 4 | RESOURCE_CODE | 编号 | string(40) | Y |  |
| 5 | RESOURCE_NAME | 名称 | string(120) | Y |  |
| 6 | OUTSIDE | 外包 | number(0/1) | Y |  |
| 7 | CAPACITY_TYPE | 产能类型 | string(40) | Y |  |
| 8 | REMARK | 备注 | string(510) | Y |  |
| 9 | RESOURCE_TYPE_ID | 类别 | GUID | Y |  |
| 10 | WORK_CALENDAR_ID | 工作历 | GUID | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | RESOURCE_D_ID | 主键 | GUID | Y | Y |
| 2 | START_DATE | 起始日期 | date | Y |  |
| 3 | END_DATE | 结束日期 | date | Y |  |
| 4 | EFFICIENCY | 工作效率 | number(5,4) | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | RESOURCE_GROUP_ID | 主键 | GUID | Y | Y |
| 4 | RESOURCE_GROUP_CODE | 编号 | string(40) | Y |  |
| 5 | RESOURCE_GROUP_NAME | 名称 | string(120) | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | RESOURCE_GROUP_D_ID | 主键 | GUID | Y | Y |
| 2 | REMARK | 备注 | string(510) | Y |  |
| 3 | RESOURCE_ID | 资源 | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | RESOURCE_TYPE_ID | 主键 | GUID | Y | Y |
| 4 | RESOURCE_TYPE_CODE | 编号 | string(40) | Y |  |
| 5 | RESOURCE_TYPE_NAME | 名称 | string(120) | Y |  |
| 6 | REMARK | 备注 | string(510) | Y |  |
| 7 | CreateDate | 创建日期 | date | Y |  |
| 8 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 9 | ModifiedDate | 修改日期 | date | Y |  |
