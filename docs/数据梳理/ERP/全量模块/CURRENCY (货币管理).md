...
| 3 | CURRENCY_ID | 主键 | GUID | Y | Y |
| 4 | CURRENCY_CODE | 货币代码 | string(12) | Y |  |
| 5 | CURRENCY_NAME | 货币名称 | string(40) | Y |  |
| 6 | UNIT | 货币单位 | string(20) | Y |  |
| 7 | DECIMAL_PLACE | 金额小数位数 | number | Y |  |
| 8 | CARRY_MODE | 金额取位模式 | number | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | CURRENCY_PRECISION_ID | 主键 | GUID | Y | Y |
| 4 | PUR_PRICE_PRECISION | 单位进价精度 | number | Y |  |
| 5 | SALE_PRICE_PRECISION | 单位售价精度 | number | Y |  |
| 6 | UNIT_WOCST_PRECISION | 单位生产成本精度 | number | Y |  |
| 7 | UNIT_ISSUECST_PRECISION | 单位发出成本精度 | number | Y |  |
| 8 | CONV_TOLERANCE | 折算容差 | number(23,8) | Y |  |
| 9 | REMARK |  | string(510) | Y |  |
| 10 | CURRENCY_ID | 主键 | GUID | Y |  |
