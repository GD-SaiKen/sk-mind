...
| 6 | DAMAGE_GOODS_ID | 主键 | GUID | Y | Y |
| 7 | CATEGORY | 单据性质 | string(40) | Y |  |
| 8 | SHOP_ID | 门店 | GUID | Y |  |
| 9 | DAMAGE_DATE | 报损日期 | date | Y |  |
| 10 | WAREHOUSE_ID | 正常仓 | GUID | Y |  |
| 11 | DAMAGE_WAREHOUSE_ID |  | GUID | Y |  |
...
| 52 | COST_DOMAIN_ID_RTK |  | string(400) | Y |  |
| 53 | COST_DOMAIN_ID_ROid |  | GUID | Y |  |
| 54 | D_COST_DOMAIN_ID_RTK |  | string(400) | Y |  |
| 55 | D_COST_DOMAIN_ID_ROid |  | GUID | Y |  |
...
| 3 | DAMAGE_REASON_ID | 主键 | GUID | Y | Y |
| 4 | DAMAGE_REASON_CODE | 报损原因编号 | string(400) | Y |  |
| 5 | DAMAGE_REASON_NAME | 报损原因名称 | string(400) | Y |  |
| 6 | ACCOUNT_CODE_ID | 财务科目编号 | GUID | Y |  |
