...
- **BP_CLUSTER (交易对象群组信息)**
- **BP_CLUSTER_D (交易对象群组属性信息)**
- **BP_PROPERTY (交易对象属性信息)**
- **BP_PROPERTY_D (交易对象属性值信息)**
...
| 3 | BP_CLUSTER_ID | 主键 | GUID | Y | Y |
| 4 | BP_CLUSTER_CODE | 交易对象群组编号 | string(400) | Y |  |
| 5 | BP_CLUSTER_NAME | 交易对象群组名称 | string(40) | Y |  |
| 6 | BP_TYPE | 对象类型 | string(40) | Y |  |
| 7 | REMARK | 备注 | string(510) | Y |  |
| 8 | CODING_FORMAT | 编码格式 | string(240) | Y |  |
| 9 | CODING_FORM | 编码样式 | string(20) | Y |  |
| 10 | PARENT_BP_CLUSTER_ID | GUID | GUID | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | BP_CLUSTER_D_ID | 主键 | GUID | Y | Y |
| 2 | INCLUDED_CODING | 纳入编码 | number(0/1) | Y |  |
| 3 | SECTION_NO | 编码段号 | number | Y |  |
| 4 | DELIMITER | 分隔符 | string(40) | Y |  |
| 5 | REMARK | 备注 | string(510) | Y |  |
| 6 | GROUP_UNIFY | 集团统一 | number(0/1) | Y |  |
| 7 | BP_PROPERTY_ID | 交易对象属性 | GUID | Y |  |
| 8 | BP_PROPERTY_D_ID | GUID | GUID | Y |  |
...
| 1 | Owner_Dept | 关联部门 | GUID | Y |  |
| 2 | Owner_Emp | 关联员工 | GUID | Y |  |
| 3 | BP_PROPERTY_ID | 主键 | GUID | Y | Y |
| 4 | BP_PROPERTY_CODE | 交易对象属性编号 | string(400) | Y |  |
| 5 | BP_PROPERTY_NAME | 交易对象属性名称 | string(400) | Y |  |
| 6 | BP_TYPE | 对象类型 | string(40) | Y |  |
| 7 | PROPERTY_TYPE | 属性类型 | string(40) | Y |  |
| 8 | DATA_TYPE | 数据类型 | string(40) | Y |  |
| 9 | DATA_SIZE | 数据长度 | number | Y |  |
| 10 | USE_METHOD | 取值方式 | string(40) | Y |  |
| 11 | BEGIN_RANGE | 区间-起 | string(20) | Y |  |
| 12 | END_RANGE | 区间-止 | string(20) | Y |  |
| 13 | REMARK | 备注 | string(510) | Y |  |
| 14 | BP_PROPERTY_FLAG | 属性字段对照名称 | string(8) | Y |  |
...
| # | Column | Description | Type | Required | PK |
|---|--------|-------------|------|----------|----|
| 1 | BP_PROPERTY_D_ID | 主键 | GUID | Y | Y |
| 2 | PROPERTY_VALUE | 属性值 | string(20) | Y |  |
| 3 | PROPERTY_VALUE_DESC | 属性值描述 | string(120) | Y |  |
