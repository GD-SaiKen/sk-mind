...
| 6 | MO_ID | 主键 | GUID | Y | Y |
| 7 | ITEM_DESCRIPTION | 产品品名 | string(120) | Y |  |
| 8 | ITEM_SPECIFICATION | 产品规格 | string(510) | Y |  |
| 9 | BOM_VERSION_TIMES | BOM版次 | string(8) | Y |  |
| 10 | BOM_DATE | BOM日期 | date | Y |  |
| 11 | URGENT | 紧急 | number(0/1) | Y |  |
| 12 | STATUS | 状态码 | string(40) | Y |  |
| 13 | LOT_MO_FLAG | 批工单 | number(0/1) | Y |  |
| 14 | PLAN_QTY | 预计产量 | number(16,6) | Y |  |
| 15 | REQ_QTY | 申请数量 | number(16,6) | Y |  |
| 16 | COMPLETED_QTY | 已生产量 | number(16,6) | Y |  |
| 17 | SCRAP_QTY | 报废数量 | number(16,6) | Y |  |
| 18 | DESTROYED_QTY | 破坏数量 | number(16,6) | Y |  |
| 19 | PLAN_START_DATE | 预计开工日期 | date | Y |  |
| 20 | PLAN_COMPLETE_DATE | 预计完工日期 | date | Y |  |
| 21 | ACTUAL_START_DATE | 实际开工日期 | date | Y |  |
| 22 | ACTUAL_COMPLETE_DATE | 实际完工日期 | date | Y |  |
| 23 | PLAN_LOT | 计划批号 | string(120) | Y |  |
| 24 | REMARK | 备注 | string(510) | Y |  |
| 25 | ROUTING_CONTROL | 工艺管理 | number(0/1) | Y |  |
| 26 | LOT_MO_QTY | 批工单数量 | number(16,6) | Y |  |
| 27 | RECEIPT_REQ_CONTROL | 入库申请 | number(0/1) | Y |  |
| 28 | SUPPLY_PURCHASED_QTY | 已采数量 | number(16,6) | Y |  |
| 29 | SUPPLY_APPLY_QTY | 分配数量 | number(16,6) | Y |  |
| 30 | SUPPLY_DISPATCH_STATUS | 分配状态 | string(40) | Y |  |
| 31 | ITEM_ID | 产品品号 | GUID | Y |  |
| 32 | BUSINESS_UNIT_ID | 业务单位 | GUID | Y |  |
| 33 | ITEM_FEATURE_ID | 特征码 | GUID | Y |  |
| 34 | ITEM_ROUTING_ID | 工艺路线号 | GUID | Y |  |
| 35 | SOURCE_MO_ID | 源工单单号 | GUID | Y |  |
| 36 | PARA_MO_ID | 母工单单号 | GUID | Y |  |
| 37 | ADMIN_UNIT_ID | 部门 | GUID | Y |  |
| 38 | UP_MO_ID | 上阶工单单号 | GUID | Y |  |
| 39 | ITEM_LOT_ID | 生产批号 | GUID | Y |  |
| 40 | ASSIGN_FINISH_PERSON | 主键 | GUID | Y |  |
| 41 | ACTUAL_START_DATETIME | 最早开工时间 | date | Y |  |
| 42 | PLAN_SECOND_QTY | 预计产量第二数量 | number(16,6) | Y |  |
| 43 | LOT_MO_SECOND_QTY | 批工单第二数量 | number(16,6) | Y |  |
| 44 | REQ_SECOND_QTY | 入库申请第二数量 | number(16,6) | Y |  |
| 45 | COMPLETED_SECOND_QTY | 已入库第二数量 | number(16,6) | Y |  |
| 46 | SCRAP_SECOND_QTY | 报废第二数量 | number(16,6) | Y |  |
| 47 | DESTROYED_SECOND_QTY | 破坏第二数量 | number(16,6) | Y |  |
| 48 | DEMAND_NO | 需求单号 | string(2000) | Y |  |
| 49 | MO_PIC | 工单图片 | string(4000) | Y |  |
| 50 | ITEM_ROUTING_CONTROL | 工艺管理 | string(40) | Y |  |
| 51 | TRANSACTION_DATE | 审核日期 | date | Y |  |
| 52 | WAREHOUSE_ID | 入库仓库 | GUID | Y |  |
| 53 | PROJECT_ID | 项目 | GUID | Y |  |
| 54 | RMA | RMA号 | string(120) | Y |  |
...
| 78 | CreateDate | 创建日期 | date | Y |  |
| 79 | LastModifiedDate | 最后修改日期 | date | Y |  |
| 80 | ModifiedDate | 修改日期 | date | Y |  |
| 81 | CreateBy | 创建者 | GUID | Y |  |
| 82 | LastModifiedBy | 最后修改者 | GUID | Y |  |
| 83 | ModifiedBy | 修改者 | GUID | Y |  |
...
| 94 | SYNERGY_ID | 协同关系 | GUID | Y |  |
| 95 | NOT_COST | 不计算成本 | number(0/1) | Y |  |
| 96 | SOURCE_FROM_RTK |  | string(400) | Y |  |
| 97 | SOURCE_FROM_ROid |  | GUID | Y |  |
