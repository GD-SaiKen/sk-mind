...
semantic_object: "BillOfMaterial/物料清单"
original_tables: 11
filtered_out: 0
...
# BOM (物料清单) - BillOfMaterial/物料清单

> [!info] Phase 1 Core Module
> Semantic Object: BillOfMaterial/物料清单
> Kept: 10 tables | Filtered out: 0 (templates/logs/backups)
> Missing CN filled: 0
