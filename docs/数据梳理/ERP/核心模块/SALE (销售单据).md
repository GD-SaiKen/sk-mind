...
columns: 1019
category: sales
semantic_object: "SalesOrder/销售单据"
original_tables: 23
filtered_out: 0
...
# SALE (销售单据) - SalesOrder/销售单据

> [!info] Phase 1 Core Module
> Semantic Object: SalesOrder/销售单据
> Kept: 23 tables | Filtered out: 0 (templates/logs/backups)
> Missing CN filled: 6

## Related Modules

- [[../modules/SALES (销售中心).md|SALES (销售中心)]]
- [[../modules/SHIPPING (出货指令).md|SHIPPING (出货指令)]]
...
- **SALE_CARD_DOC_PAYTYPE (销售卡券支付方式)**
- **SALE_DEFECTIVE_AI (销售不良品计数)**
- **SALE_DEFECTIVE_VI (销售不良品计量)**
- **SALE_INSPECTION (销退检验单)**
- **SALE_INSPECTION_D (销售单身明细)**
- **SALE_INSPECTION_D1 (销售检验单计量单身)**
- **SALE_INSPECTION_SD (销售子单身)**
- **SALE_PAYTYPE (通用收款方式信息)**
- **SALE_PRICE_TABLE (价格表)**
- **SALE_PRICE_TABLE_D (价格表单身)**
- **SALE_PRICE_TABLE_SHOP (销售价格表门店)**
- **SALE_QC_RESULT (销退质检业务)**
- **SALE_QC_RESULT_D (销退检验信息)**
- **SALE_QC_RESULT_SD (销退业务判定信息)**
- **SALE_RETURN_CARD_DOC (销售单据)**
- **SALE_RETURN_CARD_DOC_D (销售单身明细)**
- **SALE_RETURN_TICKET_DOC (售券退券单)**
- **SALE_RETURN_TICKET_DOC_D (售券退券单单身)**
- **SALE_TICKET_DOC (售券单)**
- **SALE_TICKET_DOC_D (销售单身明细)**
