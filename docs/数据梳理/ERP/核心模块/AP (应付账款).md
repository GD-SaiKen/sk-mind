...
columns: 692
category: financial
semantic_object: "AccountsPayable/应付账款"
original_tables: 15
filtered_out: 1
...
# AP (应付账款) - AccountsPayable/应付账款

> [!info] Phase 1 Core Module
> Semantic Object: AccountsPayable/应付账款
> Kept: 14 tables | Filtered out: 1 (templates/logs/backups)
> Missing CN filled: 2
...
- **AP_TRANSFER_DOC (应付单据)**
- **AP_TRANSFER_DOC_D (应付单身明细)**

## Filtered Out

> These 1 tables were excluded (templates, logs, history, backups, system):

- ~~AP_AGING_TEMPLATE~~ (template)
