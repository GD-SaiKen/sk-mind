...
columns: 1012
category: financial
semantic_object: "AccountsReceivable/应收账款"
original_tables: 22
filtered_out: 1
...
# AR (应收账款) - AccountsReceivable/应收账款

> [!info] Phase 1 Core Module
> Semantic Object: AccountsReceivable/应收账款
> Kept: 21 tables | Filtered out: 1 (templates/logs/backups)
> Missing CN filled: 0
...
- **AR_SALES_COST_ELEMENT (应收销售成本要素)**
