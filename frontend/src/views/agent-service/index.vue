<template>
  <div class="agent-page">
    <div class="breadcrumb">
      ...
      <span class="bread-current">Agent 服务</span>
    </div>
    <div class="tab-bar">
      <button
        v-for="tab in tabs"
    ...
    >
      <el-col :span="6">
        ...
        >
          <div class="info-card-header">
            <div class="info-card-icon bg-pink">
          ...
          <div class="val-row">
            ...
            <span class="badge green-bg">↑ 12%</span>
          </div>
          <div class="foot">
            <span>目标 200</span>
      ...
      <el-col :span="6">
        ...
        >
          ...
          <div class="val-row">
            <span class="val orange">96%</span>
            <span class="badge red-bg">↓ 2%</span>
          </div>
          <div class="foot">
            <span>目标 ≥99%</span>
            <div class="health-bar">
              <div
                class="health-bar-fill alert"
                style="width:96%"
              />
            </div>
            <span>96%</span>
      ...
      <el-col :span="6">
        ...
        >
          ...
          <div class="val-row">
            <span class="val green">1.2s</span>
            <span class="badge neutral">较昨日持平</span>
          </div>
      ...
      >
        <div class="query-input-area">
          ...
          <el-input
            ...
            type="textarea"
            :rows="3"
            placeholder="输入你的问题，例如：上个月销售额最高的前10个客户是谁？"
        ...
        >
          <h4>查询结果</h4>
          <div class="answer-sql">
            生成 SQL: SELECT customer_name, SUM(amount) as total FROM sales_orders WHERE order_date BETWEEN '2026-06-01' AND '2026-06-30' GROUP BY customer_name ORDER BY total DESC LIMIT 10
          </div>
          <el-table
            :data="mockResult"
            stripe
          ...
          <div class="answer-meta">
            <div class="answer-meta-row">
              ...
              <span>销售订单表、客户信息表</span>
            </div>
            <div class="answer-meta-row">
              <span class="meta-label">更新时间:</span>
              <span>2026-07-10 09:30</span>
            </div>
            <div class="answer-meta-row">
            ...
            <div class="answer-meta-row">
              ...
              <span>受控数据查询, 聚合计算</span>
            </div>
            <div class="answer-meta-row">
              <span class="meta-label">说明:</span>
              <span class="text-warning">以上数据基于已授权数据集，可能与实际业务系统存在延迟</span>
            </div>
          </div>
        </div>
      </el-card>
...
import {
  Search, Edit, Service, CircleCheckFilled, Setting, Timer, Promotion, View,
...
const filteredTools = computed(() =>
  agentTools.filter(
    t =>
      t.name.includes(searchValues.value.keyword || '') ||
      t.type.includes(searchValues.value.keyword || ''),
  ),
)
const filteredCalls = computed(() =>
  agentCalls.filter(
    c =>
      c.user.includes(searchValues.value.keyword || '') ||
      c.question.includes(searchValues.value.keyword || ''),
  ),
)
...
const pagedTools = computed(() =>
  slicePage(filteredTools.value, toolsPagination.page, toolsPagination.pageSize),
)
watch([filteredTools, () => toolsPagination.pageSize], () => {
  toolsPagination.total = filteredTools.value.length
})
...
const pagedCalls = computed(() =>
  slicePage(filteredCalls.value, callsPagination.page, callsPagination.pageSize),
)
watch([filteredCalls, () => callsPagination.pageSize], () => {
  callsPagination.total = filteredCalls.value.length
})
