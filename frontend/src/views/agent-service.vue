﻿<template>
  <div class="agent-page">
    ...
    <el-row :gutter="16" class="stat-row">
      ...
      <el-col :span="6"><el-card shadow="never" class="info-card"><div class="info-card-header"><div class="info-card-icon bg-blue"><el-icon :size="16"><Setting /></el-icon></div><span class="info-card-label">可用工具</span><span class="subtag">已配置</span></div><div class="val-row"><span class="val">5</span><span class="badge neutral">较昨日持平</span></div><div class="foot">查询 · 元数据 · 图谱</div></el-card></el-col>
...
.info-card-icon { width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; &.bg-pink { background: #fce7f3; color: #db2777; } &.bg-orange { background: #fff7ed; color: #ea580c; } &.bg-blue { background: #dbeafe; color: $color-primary; } &.bg-green { background: #dcfce7; color: $color-success; } }
...
.answer-meta { display: flex; gap: 16px; align-items: center; font-size: $font-size-sm; color: $color-text-secondary; }
